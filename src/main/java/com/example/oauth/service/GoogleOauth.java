...
public class GoogleOauth implements SocialOauth {
    ...
    private String GOOGLE_REVOKE_TOKEN;
    ...
    public GoogleOAuthToken getAccessToken(String code) throws JsonProcessingException {
        ...
        System.out.println(GOOGLE_TOKEN_REQUEST_URL);
    ...
    //refresh token
    public GoogleOAuthToken getRefreshToken(String refreshToken) throws JsonProcessingException {
        String GOOGLE_TOKEN_REQUEST_URL = env.getProperty("google.token-uri");
        System.out.println(GOOGLE_TOKEN_REQUEST_URL);
        MultiValueMap<String, String> params = new LinkedMultiValueMap<>();
    ...
    //revoke token
    public ResponseEntity requestRevokeToken(String refreshToken) throws JsonProcessingException {
        MultiValueMap<String, String> params = new LinkedMultiValueMap<>();
        ...
        HttpEntity entity = new HttpEntity( params,headers);
        ResponseEntity<String> responseEntity = restTemplate.postForEntity(GOOGLE_REVOKE_TOKEN, entity, String.class);
